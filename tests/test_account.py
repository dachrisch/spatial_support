...
from chat.play import EmailAccount, SpatialApiConnector, Space, FileAccount, AccountSecret, AuthenticatedAccount
...
class TestRegisterAccount(TestCase):
    ...
    def test_register_account_by_email(self):
        ...
        self.assertIn(Space.from_dict({'space': {'id': '1234', 'name': 'Test Space', 'slug': 'test-space'}}),
